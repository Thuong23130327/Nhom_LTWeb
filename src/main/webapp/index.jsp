...
<head>
    ...
    <title>AuraSound - Tai nghe, Loa Chính hãng</title>
...
<body>
    ...
    <div class="slideshow-container">
        <div class="slides-track">
            <div class="slide"> <a href="speakers.jsp" class="a-nodecor">

                    <img src="assets/img/banner/banner_1.png" alt="Banner 1"> </a>

            </div>

            <div class="slide"> <a href="store.jsp" class="a-nodecor">

                    <img src="assets/img/banner/banner_2.jpg" alt="Banner 2"> </a>

            </div>

            <div class="slide"> <a href="headphones.jsp" class="a-nodecor">

                    <img src="assets/img/banner/banner_3.png" alt="Banner 3"> </a>

            </div>

            <div class="slide"> <a href="speakers.jsp" class="a-nodecor">

                    <img src="assets/img/banner/banner_4.png" alt="Banner 4"> </a>
    ...
    <main class="home-container content">
        ...
        <section id="service-commitment" class="py-5">
            <div class="container row mx-auto">
                <div class="feature-box col-lg-3 col-md-6 col-12  mb-4">
                    <i class="ri-truck-line"></i>
                    <h5 class="mt-3">GIAO HÀNG SIÊU TỐC</h5>
                    <p>Miễn phí vận chuyển cho đơn hàng trên 1 triệu.</p>
                </div>
                <div class="feature-box col-lg-3 col-md-6 col-12  mb-4">
                    <i class="ri-customer-service-2-line"></i>
                    <h5 class="mt-3">HỖ TRỢ TRỰC TUYẾN</h5>
                    <p>Đội ngũ luôn sẵn sàng 24/7 để hỗ trợ bạn.</p>
                </div>
                <div class="feature-box col-lg-3 col-md-6 col-12  mb-4">
                    <i class="ri-shield-check-line"></i>
                    <h5 class="mt-3">BẢO HÀNH CHÍNH HÃNG</h5>
                    <p>Sản phẩm cam kết chất lượng 100%.</p>
                </div>
                <div class="feature-box col-lg-3 col-md-6 col-12  mb-4">
                    <i class="ri-refresh-line"></i>
                    <h5 class="mt-3">ĐỔI TRẢ DỄ DÀNG</h5>
                    <p>Đổi trả miễn phí trong 30 ngày đầu tiên.</p>
                </div>
            </div>
        </section>
        ...
        <section id="brand" class="container">
            <div class="row m-0 py5">
                ...
                <a href="JBL.jsp" class="col-lg-2 col-md-4 col-6 p-0">
                    <img class="img-fluid" src="assets/img/brand/jbl.jpg" alt="">
                </a>

                <a href="JBL.jsp" class="col-lg-2 col-md-4 col-6 p-0">
                    <img class="img-fluid" src="assets/img/brand/bose.jpg" alt="">
                </a>

                <a href="JBL.jsp" class="col-lg-2 col-md-4 col-6 p-0">
                    <img class="img-fluid"
                        src="https://hdradio.vn/upload/hinhanh/tin-tuc/tu-van-nghe-nhac/thuong-hieu-loa-nghe-nhac-noi-tieng-the-gioi/thuong-hieu-Marshall.jpg"
                        alt="">
                </a>

                <a href="JBL.jsp" class="col-lg-2 col-md-4 col-6 p-0">
                    <img class="img-fluid" src="assets/img/brand/Sennheiser.jpg" alt="">
                </a>

                <a href="JBL.jsp" class="col-lg-2 col-md-4 col-6 p-0">
                    <img class="img-fluid"
                        src="https://hdradio.vn/upload/hinhanh/tin-tuc/tu-van-nghe-nhac/thuong-hieu-loa-nghe-nhac-noi-tieng-the-gioi/thuong-hieu-sony-1.jpg"
                        alt="">
                </a>

                <a href="JBL.jsp" class="col-lg-2 col-md-4 col-6 p-0">
                    <img class="img-fluid"
                        src="https://hdradio.vn/upload/hinhanh/tin-tuc/tu-van-nghe-nhac/thuong-hieu-loa-nghe-nhac-noi-tieng-the-gioi/thuong-hieu-BW.jpg"
                        alt="">
                </a>

                <a href="JBL.jsp" class="col-lg-2 col-md-4 col-6 p-0">
                    <img class="img-fluid"
                        src="https://hdradio.vn/upload/hinhanh/tin-tuc/tu-van-nghe-nhac/thuong-hieu-loa-nghe-nhac-noi-tieng-the-gioi/thuong-hieu-harman-kardon.jpg"
                        alt="">
                </a>

                <a href="JBL.jsp" class="col-lg-2 col-md-4 col-6 p-0">
                    <img class="img-fluid"
                        src="https://hdradio.vn/upload/hinhanh/tin-tuc/tu-van-nghe-nhac/thuong-hieu-loa-nghe-nhac-noi-tieng-the-gioi/thuong-hieu-Devialet-1.jpg"
                        alt="">
                </a>

                <a href="JBL.jsp" class="col-lg-2 col-md-4 col-6 p-0">
                    <img class="img-fluid"
                        src="https://hdradio.vn/upload/hinhanh/tin-tuc/tu-van-nghe-nhac/thuong-hieu-loa-nghe-nhac-noi-tieng-the-gioi/thuong-hieu-fender.jpg"
                        alt="">
                </a>
            </div>
        </section>
        ...
        <section id="featured" class="my-5 pb-5">
            ...
            <div class="row mx-auto container-fluid">
                <div class="product  col-lg-3 col-md-4 col-12">
                    ...
                    <a href="checkout.jsp"><a href="checkout.jsp"><button class="buy-btn">Mua Ngay</button></a></a>
        ...
        <section id="Speaker" class="my-5 pb-5">

            <div class="container text-center mt-5 py-5">
                <h3>Loa Bluetooth nổi bật</h3>
                <hr class="mx-auto">
                <p>Bạn có thể tìm thấy những chiếc loa với chất lượng tốt nhất ở đây.</p>
            </div>
            ...
            <div class="row mx-auto container-fluid">
                <div class="product  col-lg-3 col-md-4 col-12">
                    <a href="sproduct.jsp" class="product-card" data-brand="Rezo" data-type="truewireless"
                       data-feature="bluetooth" data-price="460000">
                        <img src="https://cdn2.cellphones.com.vn/insecure/rs:fill:0:358/q:90/plain/https://cellphones.com.vn/media/catalog/product/a/z/azaudio-harman-kardon-soundstick-4-black-2_1.jpg"
                            alt="Loa Bluetooth Alpha Works AW-IKON20">
                        <!-- Thông tin sản phẩm -->
                        <div class="product-card-info">
                            <h4>Loa Bluetooth Harman Kardon Soundstick 4</h4>
                ...
                <div class="product  col-lg-3 col-md-4 col-12"><a href="sproduct.jsp" class="product-card"
                                                                  data-brand="ava" data-type="truewireless" data-feature="bluetooth" data-price="200000">
                        <div class="product-badge discount">
                            Giảm 20%
                        </div>
        ...
        <section id="Headphone" class="my-5 pb-5">
            ...
            <div class="container text-center mt-5 py-5">
                <h3>Tai nghe Bluetooth nổi bật</h3>
                <hr class="mx-auto">
                <p>Bạn có thể tìm thấy những chiếc tai nghe bluetooth với chất lượng tốt nhất ở đây.</p>
            </div>
            ...
            <section id="promo-banner" class="my-5 p-5 text-center">
                <div class="container">
                    <h2 class="mb-3">GIẢM GIÁ LÊN ĐẾN 40%</h2>
                    <h4 class="mb-4">Khám phá các ưu đãi đặc biệt dành cho Loa & Tai Nghe chọn lọc!</h4>
                    <a href="store.jsp" class=" a-nodecor buy-btn">KHÁM PHÁ NGAY</a>
                </div>
            </section>
        </section>
        ...
        <div id="quick-contact">
            <a href="tel:09xxxxxxx" class="contact-btn hotline-btn" title="Hotline">
                <i class="ri-phone-fill"></i>
            </a>
            <a href="https://zalo.me/sodienthoai_hoac_id" target="_blank" class="contact-btn zalo-btn"
                title="Zalo Chat">
                <i class="ri-wechat-fill"></i>
            </a>
            <a href="https://m.me/yourfacebookpage" target="_blank" class="contact-btn messenger-btn" title="Messenger">
