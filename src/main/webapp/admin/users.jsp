...
<head>
    ...
    <title>Quản lý Người dùng - Admin AuraSound</title>
            ...
            <nav id="sidebar" class="col-md-3 col-lg-2 d-md-block sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column" id="sidebar-menu">
                         <li class="nav-item">
                            <a href="admin.jsp" class="nav-link" aria-current="page"><i class="fas fa-home"></i> Admin</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="reports.jsp" class="nav-link"><i class="fas fa-chart-line"></i> Báo cáo & Thống kê</a>
                        </li>
                    </ul>
                </div>
            </nav>
