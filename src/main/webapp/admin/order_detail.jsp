...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            <!-- Sidebar đã bị loại bỏ theo yêu cầu -->
                        ...
                        <div class="col-lg-8 mb-4">
                            <div class="card shadow-sm h-100">
                                ...
                                <div class="card-header text-white card-header-shipping">
                                    <h5 class="mb-0"><i class="fas fa-map-marked-alt me-2"></i>Thông tin Giao hàng & Thanh toán</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <p class="text-muted">Đường số 6, Linh Trung, Thủ Đức, Trường ĐH Nông Lâm TP. Hồ Chí Minh</p>
                                        </div>
                                        <div class="col-md-6">
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card shadow-sm h-100">
                                ...
                                <div class="card-body">
                                    ...
                                    <p class="text-muted fst-italic">"Tôi cần giao hàng trước 5 giờ chiều ngày mai. Nếu không kịp vui lòng gọi lại."</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-4">
                            <div class="card shadow-sm h-100">
                                ...
                                <div class="card-body">
                                    <textarea class="form-control" rows="3" placeholder="Thêm ghi chú nội bộ về đơn hàng này...">Đã gọi xác nhận yêu cầu giao hàng gấp. Phối hợp với đơn vị vận chuyển để ưu tiên.</textarea>
                                    <button class="btn btn-sm btn-primary mt-2 btn-save-note"><i class="fas fa-save"></i> Lưu ghi chú</button>
                                </div>
                            </div>
                        </div>
                    </div>
