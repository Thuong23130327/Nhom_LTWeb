...
<body>
    ...
    <main class="container my-4 my-md-5">
        <div class="mb-3">
            <a href="products.jsp" class="btn btn-primary btn-gradient btn-sm rounded-3" aria-label="Quay lại danh sách Sản phẩm">
        ...
        <form class="bg-white p-4 p-md-5 rounded-3 shadow-lg">
            ...
            <section class="mb-5">
                ...
                <div class="mb-3">
                    <label for="product-name" class="form-label">Tên Sản phẩm <span class="text-required">:</span></label>
                    <input type="text" id="product-name" value="Tai nghe Sony WH-CH520 (20W)" class="form-control" placeholder="Nhập tên loa/tai nghe">
                </div>
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" id="product-sku" value="SN-WHCH-20W" class="form-control" placeholder="Nhập mã SKU sản phẩm">
                    </div>
                    <div class="col-md-6">
                        <label for="product-price" class="form-label">Giá bán (VNĐ) <span class="text-required">*</span></label>
            ...
            <section class="mb-5 border-top pt-4">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="product-waterproof" value="IPX7" class="form-control" placeholder="IPX7, IPX4, ...">
                    </div>
            ...
            <section class="mb-5 border-top pt-4">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" id="product-stock" value="85" class="form-control" placeholder="Số lượng">
                    </div>
                </div>
            </section>
